 ...
 */
class TestTreeView1 : VBox , TreeViewListener
{
...
//	}
	...
	void populate(TreeView treeView)
	{
		...
		testTreeStore.setValue(iterTop, 0, 
							new Value(new Pixbuf(package_xpm)) );
		testTreeStore.setValue(iterTop, 1, 
							new Value(new String("Icon for packages")) );
							
		iterChild = testTreeStore.append(iterTop);
		testTreeStore.setValue(iterChild, 0, 
							new Value(new Pixbuf(greenTemplate_xpm)) );
		testTreeStore.setValue(iterChild, 1, 
							new Value(new String("Icon for templates")) );
		
		iterChild = testTreeStore.append(iterTop);
		testTreeStore.setValue(iterChild, 0, 
							new Value(new Pixbuf(greenInterface_xpm)) );
		testTreeStore.setValue(iterChild, 1, 
							new Value(new String("Icon for interfaces")) );
		
		iterChild = testTreeStore.append(iterTop);
		testTreeStore.setValue(iterChild, 0, 
							new Value(new Pixbuf(greenClass_xpm)) );
		testTreeStore.setValue(iterChild, 1, 
							new Value(new String("Icon for classes")) );
