...
shared static this()
{
	...
	Linker.link(g_binding_get_type, "g_binding_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_closure_get_type, "g_closure_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_instance_get_private, "g_type_instance_get_private", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_module_get_type, "g_type_module_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_plugin_get_type, "g_type_plugin_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_value_get_type, "g_value_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_value_init_from_instance, "g_value_init_from_instance", LIBRARY.GOBJECT);
	...
	Linker.link(g_value_array_get_type, "g_value_array_get_type", LIBRARY.GOBJECT);
	...
	Linker.link(g_signal_handlers_destroy, "g_signal_handlers_destroy", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_add_instance_private, "g_type_add_instance_private", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_check_class_cast, "g_type_check_class_cast", LIBRARY.GOBJECT);
	Linker.link(g_type_check_class_is_a, "g_type_check_class_is_a", LIBRARY.GOBJECT);
	Linker.link(g_type_check_instance, "g_type_check_instance", LIBRARY.GOBJECT);
	Linker.link(g_type_check_instance_cast, "g_type_check_instance_cast", LIBRARY.GOBJECT);
	Linker.link(g_type_check_instance_is_a, "g_type_check_instance_is_a", LIBRARY.GOBJECT);
	Linker.link(g_type_check_instance_is_fundamentally_a, "g_type_check_instance_is_fundamentally_a", LIBRARY.GOBJECT);
	Linker.link(g_type_check_is_value_type, "g_type_check_is_value_type", LIBRARY.GOBJECT);
	Linker.link(g_type_check_value, "g_type_check_value", LIBRARY.GOBJECT);
	Linker.link(g_type_check_value_holds, "g_type_check_value_holds", LIBRARY.GOBJECT);
	...
	Linker.link(g_type_name_from_class, "g_type_name_from_class", LIBRARY.GOBJECT);
	Linker.link(g_type_name_from_instance, "g_type_name_from_instance", LIBRARY.GOBJECT);
