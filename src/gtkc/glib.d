...
shared static this()
{
	...
	mixin("Linker.link(g_module_open, \"g_module_open"~ _utfPostfix ~"\", LIBRARY.GLIB, LIBRARY.GMODULE);");
	Linker.link(g_module_symbol, "g_module_symbol", LIBRARY.GLIB, LIBRARY.GMODULE);
	mixin("Linker.link(g_module_name, \"g_module_name"~ _utfPostfix ~"\", LIBRARY.GLIB, LIBRARY.GMODULE);");
...
__gshared extern(C)
{
	...
	gint function(GRegex* regex) c_g_regex_get_max_lookbehind;
	...
	GVariant* function(gchar* string) c_g_variant_new_take_string;
	GVariant* function(gchar* formatString, ... ) c_g_variant_new_printf;
