...
alias void * GdkPixbufDestroyNotify;
	GdkPixbuf * gdk_pixbuf_new_from_data(guchar * data, GdkColorspace colorspace, gboolean has_alpha, int bits_per_sample, int width, int height, int rowstride, GdkPixbufDestroyNotify destroy_fn, gpointer destroy_fn_data);

	GdkPixbuf * gdk_pixbuf_new_from_xpm_data(char * *data);
	GdkPixbuf * gdk_pixbuf_new_from_inline(gint data_length, guint8 * data, gboolean copy_pixels, GError * *error);
	...
	GdkPixbuf * gdk_pixbuf_add_alpha (GdkPixbuf * pixbuf, gboolean substitute_color, guchar r, guchar g, guchar b);

	/* Copy an area of a pixbuf onto another one */
	void gdk_pixbuf_copy_area(GdkPixbuf * src_pixbuf, int src_x, int src_y, int width, int height, GdkPixbuf * dest_pixbuf, int dest_x, int dest_y);
	...
	void gdk_pixbuf_scale(GdkPixbuf * src, GdkPixbuf * dest, int dest_x, int dest_y, int dest_width, int dest_height, double offset_x, double offset_y, double scale_x, double scale_y, GdkInterpType interp_type);
	...
	GdkPixbuf * gdk_pixbuf_scale_simple(GdkPixbuf * src, int dest_width, int dest_height, GdkInterpType interp_type);
	...
	gchar * gdk_pixbuf_get_option (GdkPixbuf * pixbuf, gchar * key);
