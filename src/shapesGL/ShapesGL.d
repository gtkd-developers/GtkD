...
import dui.All;
import ggl.All;
import openGL.TrackBall;

private import std.math;
private import std.stdio;

const float DIG_2_RAD = (std.math.PI / 180.0);
const float RAD_2_DIG = (180.0 / std.math.PI);
...
,MenuItemListener
{
	...
	this(GLConfig glconfig)
	{
		...
		dispatcher.addRealizeListener(this,da);
		dispatcher.addMapListener(this,da);
		dispatcher.addExposeListener(this,da);
		dispatcher.addConfigureListener(this,da);
		dispatcher.addVisibilityListener(this,da);
		//dispatcher.addButtonClickedListener(this,da);
		dispatcher.addMouseButtonListener(this,da);
		dispatcher.addMouseMotionListener(this,da);
	...
	bit noExposeCallback(Widget widget){return false;}

	bit configureCallback(Widget widget, EventConfigure e)
	{
		GLDrawable drawable = GLWidget.getGLDrawable(widget);
		GLContext context = GLWidget.getGLContext(widget);
		GLfloat w = widget.getWidth();
		GLfloat h = widget.getHeight();
		GLfloat aspect;
	...
	bit unrealizeCallback(Widget widget){return false;}
...
static float dy = 0.0;
	...
	bit mouseButtonPressCallback(Widget widget, EventButton event)
	{
		if (event.button() == 1)
		{
			if (animate)
	...
	bit mouseButtonReleaseCallback(Widget widget, EventButton e)
	{
		if (e.button() == 1)
		{
		...
		{
			/* Popup menu. */
			menu.popup(null,null,null,null,e.button(), e.getTime());
			return true;
		}
	...
	bit motionNotifyCallback(Widget widget, EventMotion event)
	{
		float w = widget.getWidth();
		float h = widget.getHeight();
		float x = event.getX();
		float y = event.getY();
		printf("ShapesGL.motionNotifyCallback x,y = %d,%d\n", x,y);
		...
		/* Scaling. */
		if (event.testState(ModifierType.BUTTON2_MASK) )
		{
...
//
	...
	Menu createPopupMenu()
	{
		...
		*/
		...
		menu.append(new MenuItem(this,"Cube","shapes.Cube"));
		menu.append(new MenuItem(this,"Sphere","shapes.Sphere"));
		menu.append(new MenuItem(this,"Cone","shapes.Cone"));
		menu.append(new MenuItem(this,"Torus","shapes.Torus"));
		menu.append(new MenuItem(this,"Tetrahedron","shapes.Tetrahedron"));
		menu.append(new MenuItem(this,"Octahedron","shapes.Octahedron"));
		menu.append(new MenuItem(this,"Dodecahedron","shapes.Dodecahedron"));
		menu.append(new MenuItem(this,"Icosahedron","shapes.Icosahedron"));
		menu.append(new MenuItem(this,"Teapot","shapes.Teapot"));
		
		/*
		 * Materials submenu.
		 */
		
		menu.append(new MenuItem(this,"Emerald","materials.Emerald"));
		menu.append(new MenuItem(this,"Jade","materials.Jade"));
		menu.append(new MenuItem(this,"Obsidian","materials.Obsidian"));
		menu.append(new MenuItem(this,"Pearl","materials.Pearl"));
		menu.append(new MenuItem(this,"Ruby","materials.Ruby"));
		menu.append(new MenuItem(this,"Turquoise","materials.Turquoise"));
		menu.append(new MenuItem(this,"Brass","materials.Brass"));
		menu.append(new MenuItem(this,"Bronze","materials.Bronze"));
		menu.append(new MenuItem(this,"Chrome","materials.Chrome"));
		menu.append(new MenuItem(this,"Copper","materials.Copper"));
		menu.append(new MenuItem(this,"Gold","materials.Gold"));
		menu.append(new MenuItem(this,"Silver","materials.Silver"));
		...
		/* Quit */
		menu.append(new MenuItem(this,"Quit","quit"));	
...
void main(char [][]args)
{
	...
	*/
	...
	GLConfig configgl = new GLConfig(GLConfigMode.RGB | GLConfigMode.DEPTH | GLConfigMode.DOUBLE);
	if (configgl.ggl() === null)
	{
	  printf ("*** Cannot find the double-buffered visual.\n");
	  printf ("*** Trying single-buffered visual.\n");
	
	  /* Try single-buffered visual */
	  configgl = new GLConfig(GLConfigMode.RGB    |
								   GLConfigMode.DEPTH);
	  if (configgl.ggl() === null )
		{
	...
	if ( configgl.ggl() !== null )
	{
		...
		testGL.add(new ShapesGL(configgl));
		//dui.thread.wait();
		dui.go();
	}
