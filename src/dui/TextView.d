...
extern (C)
{
	...
	void gtk_text_view_get_iter_location(GtkTextView * text_view, GtkTextIter * iter, GdkRectangle * location);
	void gtk_text_view_get_iter_at_location(GtkTextView * text_view, GtkTextIter * iter, gint x, gint y);
	void gtk_text_view_get_line_yrange(GtkTextView * text_view, GtkTextIter * iter, gint * y, gint * height);
