...
extern (C)  GtkWidget * gtk_table_new(int, int, int);
extern (C)  void gtk_table_attach_defaults(void *, void *, int, int, int, int);

extern (C)  void gtk_table_resize(void * table, int rows, int columns);
extern (C)  void gtk_table_attach(
	void * table,
	void * child,
	int left_attach,
	int right_attach,
	...
	int xpadding,
	int ypadding);
extern(C) void gtk_table_set_row_spacing(void * table, int row, int spacing);
extern(C) int gtk_table_get_row_spacing(void * table, int row);
extern(C) void gtk_table_set_col_spacing(void * table, int column, int spacing);
extern(C) int gtk_table_get_col_spacing(void * table, int column);
extern(C) void gtk_table_set_row_spacings(void * table, int spacing);
extern(C) int gtk_table_get_default_row_spacing(void * table);
extern(C) void gtk_table_set_col_spacings(void * table, int spacing);
extern(C) int gtk_table_get_default_col_spacing(void * table);
extern(C) void gtk_table_set_homogeneous(void * table, int homogeneous);
extern(C) int gtk_table_get_homogeneous(void * table);
