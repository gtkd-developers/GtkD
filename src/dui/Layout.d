...
extern (C) GtkWidget * gtk_layout_new(GtkAdjustment * hadjustment, GtkAdjustment * vadjustment);
extern (C) void gtk_layout_put(GtkLayout * layout, GtkWidget * child_widget, gint x, gint y);
extern (C) void gtk_layout_move(GtkLayout * layout, GtkWidget * child_widget, gint x, gint y);
extern (C) void gtk_layout_set_size(GtkLayout * layout, guint width, guint height);
extern (C) void gtk_layout_get_size(GtkLayout * layout, guint * width, guint * height);
extern (C) GtkAdjustment * gtk_layout_get_hadjustment(GtkLayout * layout);
extern (C) GtkAdjustment * gtk_layout_get_vadjustment(GtkLayout * layout);
extern (C) void gtk_layout_set_hadjustment(GtkLayout * layout, GtkAdjustment * adjustment);
extern (C) void gtk_layout_set_vadjustment(GtkLayout * layout, GtkAdjustment * adjustment);
