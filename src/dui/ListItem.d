...
extern (C) GType gtk_list_item_get_type();
extern (C) GtkWidget* gtk_list_item_new();
extern (C) GtkWidget* gtk_list_item_new_with_label(gchar *label);
extern (C) void gtk_list_item_select(GtkListItem *list_item);
extern (C) void gtk_list_item_deselect(GtkListItem *list_item);
