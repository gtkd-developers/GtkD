...
extern (C) GtkWidget * gtk_statusbar_new();
extern (C) guint gtk_statusbar_get_context_id(GtkStatusbar * statusbar, gchar * context_description);
extern (C) guint gtk_statusbar_push(GtkStatusbar * statusbar, guint context_id, gchar * text);
extern (C) void gtk_statusbar_pop(GtkStatusbar * statusbar, guint context_id);
extern (C) void gtk_statusbar_remove(GtkStatusbar * statusbar, guint context_id, guint message_id);
extern (C) void gtk_statusbar_set_has_resize_grip(GtkStatusbar * statusbar, gboolean setting);
extern (C) gboolean gtk_statusbar_get_has_resize_grip(GtkStatusbar * statusbar);
