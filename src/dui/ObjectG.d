...
private extern(C)
{
	...
	gpointer g_object_new(GType object_type, gchar * first_property_name,...);
	...
	gpointer g_object_connect(gpointer object, gchar * signal_spec,...);
	void g_object_disconnect(gpointer object, gchar * signal_spec,...);
	void g_object_set_valist(GObject * object, gchar * first_property_name, vaList var_args);
	void g_object_get_valist(GObject * object, gchar * first_property_name, vaList var_args);
	void g_object_set_property(GObject * object, gchar * property_name, GValue * value);
	void  g_object_get_property(GObject * object, gchar * property_name, GValue * value);
	void g_object_freeze_notify(GObject * object);
	void g_object_notify(GObject * object, gchar * property_name);
	...
	void g_object_set_data_full(GObject * object, gchar * key, gpointer data, GDestroyNotify destroy);
	gpointer g_object_steal_data(GObject * object, gchar * key);
