...
extern (C) GtkWidget * gtk_radio_button_new(GSList * group);
extern (C) GtkWidget * gtk_radio_button_new_from_widget(GtkRadioButton * group);
extern (C) GtkWidget * gtk_radio_button_new_with_label(GSList * group, gchar * label);
extern (C) GtkWidget * gtk_radio_button_new_with_label_from_widget(GtkRadioButton * group, gchar * label);
extern (C) GtkWidget * gtk_radio_button_new_with_mnemonic(GSList * group, gchar * label);
extern (C) GtkWidget * gtk_radio_button_new_with_mnemonic_from_widget(GtkRadioButton * group, gchar * label);
extern (C) GSList * gtk_radio_button_get_group(GtkRadioButton * radio_button);
extern (C) void gtk_radio_button_set_group(GtkRadioButton * radio_button, GSList * group);
