...
private:
extern (C) GtkWidget * gtk_accel_label_new(gchar * string);
extern (C) GtkWidget * gtk_accel_label_get_accel_widget(GtkAccelLabel * accel_label);
extern (C) guint gtk_accel_label_get_accel_width(GtkAccelLabel * accel_label);
extern (C) void gtk_accel_label_set_accel_widget(GtkAccelLabel * accel_label, GtkWidget * accel_widget);
extern (C) void gtk_accel_label_set_accel_closure(GtkAccelLabel * accel_label, GClosure * accel_closure);
extern (C) gboolean gtk_accel_label_refetch(GtkAccelLabel * accel_label);
