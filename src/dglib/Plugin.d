...
extern(C)
{
	...
	GModule* g_module_open(gchar *file_name, GModuleFlags flags);
	
	/* close a previously opened module, returns TRUE on success */
	gboolean g_module_close(GModule * mod);
	...
	gboolean g_module_symbol(GModule *mod, gchar *symbol_name, gpointer *symbol);
	
	/* retrieve the file name from an existing module */
	gchar* g_module_name(GModule *mod);
	 ...
	 */
	gchar* g_module_build_path(gchar *directory, gchar *module_name);
