...
enum DUIType {
	...
	PARAM = 76,
	OBJECT = 80,
	/* PIXBUF: segfaults gtk_tee_store_newv() if active */
	// PIXBUF = 134614632, 
};
...
enum Stock
{ 
	DIALOG_INFO, DIALOG_WARNING, DIALOG_ERROR, DIALOG_QUESTION, DND,
	DND_MULTIPLE, ADD, APPLY, BOLD, CANCEL, CDROM, CLEAR, CLOSE, COLOR_PICKER,
	CONVERT, COPY, CUT, DELETE, EXECUTE, FIND, FIND_AND_REPLACE,
	FLOPPY, GOTO_BOTTOM, GOTO_FIRST, GOTO_LAST, GOTO_TOP, GO_BACK, GO_DOWN,
	GO_FORWARD, GO_UP, HARDDISK, HELP, HOME, INDEX, INDENT, UNINDENT, ITALIC,
	JUMP_TO, JUSTIFY_CENTER, JUSTIFY_FILL, JUSTIFY_LEFT, JUSTIFY_RIGHT, MISSING_IMAGE,
	NETWORK, NEW, NO, OK, OPEN, PASTE, PREFERENCES, PRINT, PRINT_PREVIEW, PROPERTIES,
	QUIT, REDO, REFRESH, REMOVE, REVERT_TO_SAVED, SAVE, SAVE_AS, SELECT_COLOR,
	SELECT_FONT, SORT_ASCENDING, SORT_DESCENDING, SPELL_CHECK, STOP, STRIKETHROUGH,
	UNDELETE, UNDERLINE, UNDO, YES, ZOOM_100, ZOOM_FIT, ZOOM_IN, ZOOM_OUT
}
