...
{	
	...
	{
		return cast(PositionType)gtk_handle_box_get_handle_position(cast(GtkHandleBox*)gtkW());
	}
	...
	{
		return cast(PositionType)gtk_handle_box_get_snap_edge(cast(GtkHandleBox*)gtkW());
	}
