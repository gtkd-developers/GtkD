...
curl http://chuangtzu.acc.umu.se/pub/gnome/sources/gtksourceview/2.1/gtksourceview-2.1.3.tar.bz2 | tar xvfj -
ln -s gtksourceview-2.1.3/docs/reference/html sourceview
