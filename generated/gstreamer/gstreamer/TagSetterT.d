...
public template TagSetterT(TStruct)
{
	...
	{
		gst_tag_setter_add_tag_valist(getTagSetterStruct(), mode, Str.toStringz(tag), varArgs);
	}
	...
	{
		gst_tag_setter_add_tag_valist_values(getTagSetterStruct(), mode, Str.toStringz(tag), varArgs);
	}
	...
	{
		gst_tag_setter_add_tag_value(getTagSetterStruct(), mode, Str.toStringz(tag), (value is null) ? null : value.getValueStruct());
	}
	...
	{
		return gst_tag_setter_get_tag_merge_mode(getTagSetterStruct());
	}
	...
	{
		gst_tag_setter_merge_tags(getTagSetterStruct(), (list is null) ? null : list.getTagListStruct(), mode);
	}
	...
	{
		gst_tag_setter_reset_tags(getTagSetterStruct());
	}
	...
	{
		gst_tag_setter_set_tag_merge_mode(getTagSetterStruct(), mode);
	}
}
