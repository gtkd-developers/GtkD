...
__gshared extern(C)
{
	...
	PangoEngineShape* pango_font_find_shaper(PangoFont* font, PangoLanguage* language, uint ch);
	...
	void pango_map_get_engines(PangoMap* map, PangoScript script, GSList** exactEngines, GSList** fallbackEngines);
	PangoMap* pango_find_map(PangoLanguage* language, uint engineTypeId, uint renderTypeId);
	void pango_module_register(PangoIncludedModule* module_);
