...
public class TextBuffer : ObjectG
{
	 ...
	 */
	public void insertTexture(TextIter iter, Texture texture)
	{
		gtk_text_buffer_insert_texture(gtkTextBuffer, (iter is null) ? null : iter.getTextIterStruct(), (texture is null) ? null : texture.getTextureStruct());
	}
	 ...
	 */
	gulong addOnInsertTexture(void delegate(TextIter, Texture, TextBuffer) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
		return Signals.connect(this, "insert-texture", dlg, connectFlags ^ ConnectFlags.SWAPPED);
	}
