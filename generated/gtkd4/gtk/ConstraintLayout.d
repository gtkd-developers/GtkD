...
public class ConstraintLayout : LayoutManager, BuildableIF
{
	...
	public ListG addConstraintsFromDescriptionv(string lines, int hspacing, int vspacing, HashTable views)
	{
		...
		auto __p = gtk_constraint_layout_add_constraints_from_descriptionv(gtkConstraintLayout, Str.toStringz(lines), cast(size_t)lines.length, hspacing, vspacing, (views is null) ? null : views.getHashTableStruct(), &err);
	 ...
	 *
	 * Returns: a #GListModel tracking @layout's
	 *     constraints
	 */
