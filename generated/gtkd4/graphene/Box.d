...
public class Box
{
	 ...
	 * Since: 1.2
	 */
	public void getVertices(Vec3[8] vertices)
	{
		graphene_vec3_t[] verticesArray = new graphene_vec3_t[vertices.length];
		for ( int i = 0; i < vertices.length; i++ )
		{
			verticesArray[i] = *(vertices[i].getVec3Struct());
		}

		graphene_box_get_vertices(graphene_box, verticesArray.ptr);
	}
