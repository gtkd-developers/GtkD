...
public class Frustum
{
	 ...
	 * Since: 1.2
	 */
	public void getPlanes(Plane[6] planes)
	{
		graphene_plane_t[] planesArray = new graphene_plane_t[planes.length];
		for ( int i = 0; i < planes.length; i++ )
		{
			planesArray[i] = *(planes[i].getPlaneStruct());
		}

		graphene_frustum_get_planes(graphene_frustum, planesArray.ptr);
	}
