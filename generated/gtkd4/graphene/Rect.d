...
public class Rect
{
	 ...
	 * Since: 1.4
	 */
	public void getVertices(Vec2[4] vertices)
	{
		graphene_vec2_t[] verticesArray = new graphene_vec2_t[vertices.length];
		for ( int i = 0; i < vertices.length; i++ )
		{
			verticesArray[i] = *(vertices[i].getVec2Struct());
		}

		graphene_rect_get_vertices(graphene_rect, verticesArray.ptr);
	}
